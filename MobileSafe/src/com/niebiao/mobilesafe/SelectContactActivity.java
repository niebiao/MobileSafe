...
public class SelectContactActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list_select_contact = (ListView) findViewById(R.id.lv_select_contact);
		final List<Map<String,String>> data= getContactInfo();
		list_select_contact.setAdapter(new SimpleAdapter(this, data, 
	        		R.layout.activity_contact_item, new String[]{"name","phone"}, new int[] {R.id.tv_name,R.id.tv_phone}));
		...
		while(cursor.moveToNext()){
			...
			if (contact_id!=null) {
				...
				while(dataCursor.moveToNext()){
					...
					System.out.println("data1="+data1+" , "+"mipmap="+mimetype);
